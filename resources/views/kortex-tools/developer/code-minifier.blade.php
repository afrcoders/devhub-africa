...
@section('title', 'Code Minifier - KortexTools')
@section('description', 'Minify and compress your CSS, JavaScript, and HTML code to reduce file sizes and improve loading times.')
@section('keywords', 'code minifier, css minifier, javascript minifier, html minifier, compress code')
        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-compress-alt me-2"></i>Code Minifier</h4>
                    <small>Compress your CSS, JavaScript, and HTML code</small>
                </div>
                <div class="card-body">
