...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">My Business Dashboard</h1>
            <p class="text-gray-600 mt-2">Manage your business listings and track performance</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $stats['active_businesses'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $stats['pending_businesses'] }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">My Business Listings</h3>
            </div>
                                        ...
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-lg bg-purple-100 flex items-center justify-center">
                                                    <span class="text-purple-600 font-semibold text-sm">{{ substr($business->name, 0, 2) }}</span>
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $business->name }}</div>
                                                <div class="text-sm text-gray-500">{{ $business->city }}, {{ $business->country }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
            ...
            @else
                <div class="px-6 py-12 text-center">
                    ...
                    <h3 class="mt-4 text-sm font-medium text-gray-900">No business listings</h3>
                    <p class="mt-2 text-sm text-gray-500">Get started by creating your first business listing.</p>
                    <div class="mt-6">
                        <a href="{{ route('noccea.business.businesses.create') }}" 
