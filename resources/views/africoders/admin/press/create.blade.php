...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.africoders.press.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" placeholder="Enter press release title" required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" rows="3" placeholder="Brief summary (will appear in listings)" required>{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('author') is-invalid @enderror" name="author" value="{{ old('author') }}" placeholder="Author name" required>
                            @error('author')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('press_category') is-invalid @enderror" name="press_category" required>
                                ...
                                <option value="announcement" {{ old('press_category') === 'announcement' ? 'selected' : '' }}>Announcement</option>
                                <option value="award" {{ old('press_category') === 'award' ? 'selected' : '' }}>Award</option>
                                <option value="partnership" {{ old('press_category') === 'partnership' ? 'selected' : '' }}>Partnership</option>
                                <option value="funding" {{ old('press_category') === 'funding' ? 'selected' : '' }}>Funding</option>
                                <option value="milestone" {{ old('press_category') === 'milestone' ? 'selected' : '' }}>Milestone</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('venture_id') is-invalid @enderror" name="venture_id">
                                ...
                                @foreach($ventures as $venture)
                                    <option value="{{ $venture->id }}" {{ old('venture_id') === (string)$venture->id ? 'selected' : '' }}>
                                        {{ $venture->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-check-lg"></i> Create Press Release
                            </button>
