...
<div class="alert alert-info mb-4">
    ...
    Convert AVIF image files to JPG format while maintaining image quality and optimizing file size.
</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Choose an AVIF image file to convert to JPG format</div>
                            </div>
    ...
    reader.onload = function(e) {
        ...
        img.onload = function() {
            ...
            canvas.toBlob(function(blob) {
                ...
                convertBtn.innerHTML = '<i class="fas fa-magic me-2"></i>Convert to JPG';
            }, 'image/jpeg', quality);
        };
...
downloadBtn.addEventListener('click', function() {
    ...
    a.href = url;
    a.download = fileInput.files[0].name.replace(/\.[^/.]+$/, '') + '.jpg';
