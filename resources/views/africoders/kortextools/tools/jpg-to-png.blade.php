                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Select one or more JPG files to convert to PNG format</div>
                            </div>
                            ...
                            <div class="mb-3" id="qualitySection" style="display: none;">
                                <label for="qualitySlider" class="form-label">PNG Compression Quality</label>
                                <input type="range" class="form-range" id="qualitySlider" min="0.1" max="1" step="0.1" value="1">
                                <div class="d-flex justify-content-between">
                                    <small class="text-muted">Low Quality</small>
                                    <small class="text-muted">High Quality</small>
                                </div>
                                <div class="text-center mt-2">
                                    <span id="qualityValue" class="badge bg-primary">100%</span>
                                </div>
                            </div>
...
function convertToPng(file, quality) {
...
convertBtn.addEventListener('click', async function() {
    ...
    for (let i = 0; i < selectedFiles.length; i++) {
        ...
        try {
            const converted = await convertToPng(file, quality);
