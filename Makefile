...
help:
	@echo "Africoders Portal - Developer Community Platform"
	@echo ""
...
install: ## Install and setup application
	...
	@echo "\n✅ Africoders Portal installed! Access at http://localhost:8080"
...
mysql: ## Open MySQL CLI
	docker compose exec mysql mysql -u africoders -psecret africoders
